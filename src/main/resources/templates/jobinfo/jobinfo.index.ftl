			              	...
			              	<table id="job_list" class="table table-bordered table-striped" width="100%" >
				                <thead>
					            	<tr>
                                        ...
                                        <#--<th name="executorHandler" >${I18n.jobinfo_field_jobdname}</th>-->
         	...
         	<div class="modal-body">
				<form class="form-horizontal form" role="form" >
                    ...
                    <div class="form-group">
                        ...
                        <label for="lastname" class="col-sm-2 control-label"><a href="http://cron.qqe2.com/" target="_blank">Cron</a><font color="red">*</font></label>
...
public class DemoGlueJobHandler extends IJobHandler {
	...
	public ReturnT<String> execute(String param) throws Exception {
		XxlJobLogger.log("JOB-ADMIN, Hello World.");
